        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/auth/signup"
              ...
              START SCANNING FREE <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <a href="#demo" className="flex items-center gap-2 border border-border-bright text-text-secondary font-display font-bold text-lg px-8 py-3.5 rounded hover:border-accent-blue hover:text-white transition-all">
