      ...
      <section className="pt-36 pb-24 px-4 relative">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/auth/login"
              className="flex items-center gap-2 bg-accent-green text-bg-primary font-display font-bold text-lg px-8 py-3.5 rounded hover:bg-accent-green/90 transition-all hover:shadow-[0_0_30px_rgba(0,255,136,0.3)]"
            >
              VIEW DEMO FEED
            </Link>
          </div>
